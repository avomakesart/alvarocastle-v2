    ...
    <>
      <footer className='mt-4 body-font'>
        <div className='container flex flex-col flex-wrap px-5 py-6 mx-auto sm:flex-row'>
          <p className='text-sm text-center text-gray-900 sm:text-left '>
            Designed & Builded by
            <span
          ...
          <span className='inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start'>
            <span
              className='ml-4 text-black hover:text-blue-500'
              onClick={() =>
            ...
            <p className='text-sm text-center text-gray-900 ml-4 sm:text-left'>
              {' '}
              v {jsonData.version}
            </p>
          </span>
